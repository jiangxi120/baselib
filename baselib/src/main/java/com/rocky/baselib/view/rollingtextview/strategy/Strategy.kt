...
import com.rocky.baselib.view.rollingtextview.RollingTextView
...
object Strategy {
     ...
     */
    @JvmStatic
    fun CarryBitAnimation(direction: Direction = Direction.SCROLL_DOWN): CharOrderStrategy = NonZeroFirstAnimation(CarryBitStrategy(direction))
